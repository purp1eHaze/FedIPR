...
class BasicPrivateBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, passport_kwargs={}):#(512, 512, 2) (512, 512, 1)
        ...
        if stride != 1 or in_planes != self.expansion * planes:
            self.shortcut = get_convblock(passport_kwargs['shortcut'])(in_planes, self.expansion * planes, 1, stride, 0) # input, output, kernel_size=1
